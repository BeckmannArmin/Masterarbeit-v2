...
class SelectionButton extends StatefulWidget {
  const SelectionButton({Key key, this.initialSelected, this.data, this.onSelected}) : super(key: key);
...
class _SelectionButtonState extends State<SelectionButton> {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: 
        widget.data.asMap().entries.map((MapEntry<int, SelectionButtonData> e) {
        final int index = e.key;
        final SelectionButtonData data = e.value;
