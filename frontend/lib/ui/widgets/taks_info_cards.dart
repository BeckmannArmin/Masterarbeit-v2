  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: GridView.builder(
        ...
        itemBuilder: (BuildContext context, int index) => tasksList[index].isLast ? 
        _buildAddTask() : 
  ...
  Widget _buildTask(BuildContext context, TaskCard taskCard) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          Icon(taskCard.iconData, color: taskCard.iconColor, size: 25,),
          ...
          Row(
            children: [
              _buildTaskStatus(taskCard.btnColor, taskCard.iconColor, '${taskCard.left} left'),
              const SizedBox(width: 10),
              _buildTaskStatus(Colors.white, taskCard.iconColor, '${taskCard.done} done')
            ],
          )
        ],
      ),
